...
SECRET_KEY = 'django-insecure-bexc!_c2vc@z(2*qsq$b)vk8@1knzkx$be6hb0!w)&)ukw3ft1'
...
STATICFILES_DIRS=[
    os.path.join(BASE_DIR,'hacker_news/static'),
]
...
CELERY_BEAT_SCHEDULE = { # scheduler configuration 
    'Task_one_schedule' : {  # whatever the name you want 
        'task': 'hacker_news.tasks.update', # name of task with path
